        ...
        actions={
          <>
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg border border-[var(--portal-border)] bg-[var(--portal-surface)] px-4 py-2 text-sm font-medium text-[var(--portal-foreground)] transition hover:bg-[var(--portal-surface-soft)]"
            >
              Projects
            </Link>
